...
for N = Nvec
    ...
    for i = 1:simutimes
        [distances_deviation1,distances_deviation2_vec]=simu_on_tree_network_small1(N);
        result(i,:) = [distances_deviation1,distances_deviation2_vec];
    end
    filename = sprintf("D:\\data\\ISPP_givenA\\complete_random_demand\\small1LPvsQiu_N%d.txt",N);
    writematrix(result,filename)
end



function [distances_deviation1,distances_deviation2_vec]=simu_on_tree_network_small1(N)
    %for a tree network
