...
filename = sprintf("D:\\data\\ISPP_givenA\\complete_random_demand\\SiyuData\\discrete\\LPvsQiu_N%ddataper%.2f%.2f%.2f_siyuinput_treefromERp05_hungsupp.txt",N,dsmall,dmid,dlarge);
writematrix(result,filename)
end

function [distances_deviation1,t_LP,tree_diameter]=simu_on_tree_network(N, dsmall,dmid,dlarge)
    %for a tree network
