...
%             a = sum(results<=time_shreshold,1)/1000
        ...
        maxt = max(results_0(:,8:14))
        avet = mean(results_0(:,8:14))
        mint = min(results_0(:,8:14))
    ...
    writematrix(output_matrix, 'D:\\data\\ISPP_givenA\\final_data\\scheduled_instance_matrix_diffdiameter_maxistf.csv');
